...
FuzzySugenoIntegral::FuzzySugenoIntegral() : firstTime(true), frameNumber(0),
framesToLearn(10), alphaLearn(0.1), alphaUpdate(0.01), colorSpace(1), option(2), smooth(true), threshold(0.67)
{
}
FuzzySugenoIntegral::FuzzySugenoIntegral(long long frameNumber, int framesToLearn, double alphaLearn, double alphaUpdate,
	int colorSpace, int option, bool smooth, double threshold)
	: firstTime(false), frameNumber(frameNumber),
...
// Save parameters
void FuzzySugenoIntegral::SaveParameter(std::string folderName) {
	std::ofstream myfile;
