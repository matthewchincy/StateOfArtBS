...
T2FMRF_UV::T2FMRF_UV() 
	: firstTime(true), frameNumber(0), threshold(9.0), alpha(0.01), 
km(2.f), kv(0.9f), gaussians(3)
{
}
T2FMRF_UV::T2FMRF_UV(long frameNumber, double threshold, double alpha, float km, float kv, int gaussians)
...
// Save parameters
void T2FMRF_UV::SaveParameter(std::string folderName) {
	std::ofstream myfile;
