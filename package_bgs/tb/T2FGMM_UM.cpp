...
T2FGMM_UM::T2FGMM_UM() : firstTime(true), frameNumber(0), threshold(9.0), alpha(0.01), km(1.5f), kv(0.6f), gaussians(3)
{
}
T2FGMM_UM::T2FGMM_UM(long frameNumber, double threshold, double alpha, float km, float kv, int gaussians)
...
// Save parameters
void T2FGMM_UM::SaveParameter(std::string folderName) {
	std::ofstream myfile;
