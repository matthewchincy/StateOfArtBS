...
#define BGSPBAS_DEFAULT_ALPHA (7.0f)
#define BGSPBAS_DEFAULT_BETA (1.0f)
#define BGSPBAS_DEFAULT_N (20)
#define BGSPBAS_DEFAULT_R_LOWER (18)
#define BGSPBAS_DEFAULT_RAUTE_MIN (2)
#define BGSPBAS_DEFAULT_T_LOWER (2)
#define BGSPBAS_DEFAULT_T_UPPER (200)
#define BGSPBAS_DEFAULT_R_SCALE (5)
#define BGSPBAS_DEFAULT_R_INCDEC (0.05f)
#define BGSPBAS_DEFAULT_T_DEC (0.05f)
#define BGSPBAS_DEFAULT_T_INC (1)
...
public:
	//! full constructor
	PBAS(float alpha = BGSPBAS_DEFAULT_ALPHA,
		float beta = BGSPBAS_DEFAULT_BETA,
		int N = BGSPBAS_DEFAULT_N,
		int Raute_min = BGSPBAS_DEFAULT_RAUTE_MIN,
		float R_incdec = BGSPBAS_DEFAULT_R_INCDEC,
		int R_lower = BGSPBAS_DEFAULT_R_LOWER,
		int R_scale = BGSPBAS_DEFAULT_R_SCALE,
		float T_dec = BGSPBAS_DEFAULT_T_DEC,
		int T_inc = BGSPBAS_DEFAULT_T_INC,
		int T_init = BGSPBAS_DEFAULT_R_LOWER,
		int T_lower = BGSPBAS_DEFAULT_T_LOWER,
		int T_upper = BGSPBAS_DEFAULT_T_UPPER);

	virtual ~PBAS();
	virtual void operator()(cv::InputArray _image, cv::OutputArray _fgmask);
