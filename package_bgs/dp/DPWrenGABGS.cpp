...
DPWrenGABGS::DPWrenGABGS() : firstTime(true), frameNumber(0), threshold(12.25f), alpha(0.005f), learningFrames(30)
{
}
DPWrenGABGS::DPWrenGABGS(long frameNumber, double threshold, double alpha, int learningFrames) :
	firstTime(true), frameNumber(frameNumber), threshold(threshold), alpha(alpha), learningFrames(learningFrames)
{
}
...
// Save parameters
void DPWrenGABGS::SaveParameter(std::string folderName) {
	std::ofstream myfile;
