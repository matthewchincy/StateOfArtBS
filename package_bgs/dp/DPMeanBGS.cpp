...
DPMeanBGS::DPMeanBGS() : firstTime(true), frameNumber(0), threshold(2700), alpha(1e-6f), learningFrames(30)
{
}
DPMeanBGS::DPMeanBGS(long framenumber, int threshold, double alpha, int learningframes) :
...
// Save parameters
void DPMeanBGS::SaveParameter(std::string folderName) {
	std::ofstream myfile;
