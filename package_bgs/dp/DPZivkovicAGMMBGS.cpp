...
DPZivkovicAGMMBGS::DPZivkovicAGMMBGS() : firstTime(true), frameNumber(0), threshold(25.0f), alpha(0.001f), gaussians(3)
{
}
DPZivkovicAGMMBGS::DPZivkovicAGMMBGS(long frameNumber, double threshold, double alpha, int gaussians) :
...
// Save parameters
void DPZivkovicAGMMBGS::SaveParameter(std::string folderName) {
	std::ofstream myfile;
